...
func (storage *SystemRewardStorage) Generate(genesis *core.Genesis, allocAccounts *[]common.Address, mapAllocAccountStorageKeys *map[common.Address][]common.Hash) {
	...
	contractNames := [3]string{"SystemReward", "ProxyAdmin", "TransparentUpgradeableProxy"}
	contractAddrs := [3]string{"0x0000000000000000000000000000000000001080", "0x0000000000000000000000000000000000001081", "0x0000000000000000000000000000000000001082"}

...
func NewSystemRewardStorage(tool *types.Tool) *SystemRewardStorage {
    return &SystemRewardStorage{
...
func (s *SystemRewardStorage) Generate(alloc *types.GenesisAlloc) {
    utils.Compile(s.solcPath, s.contractPath, "SystemReward.sol")

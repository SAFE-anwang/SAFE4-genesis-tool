...
func NewMasterNodeStateStorage(tool *types.Tool) *MasterNodeStateStorage {
    return &MasterNodeStateStorage{
...
func (s *MasterNodeStateStorage) Generate(alloc *types.GenesisAlloc) {
    utils.Compile(s.solcPath, s.contractPath, "MasterNodeState.sol")

    contractNames := [2]string{"TransparentUpgradeableProxy", "MasterNodeState"}
    contractAddrs := [2]string{"0x0000000000000000000000000000000000001050", "0x0000000000000000000000000000000000001051"}

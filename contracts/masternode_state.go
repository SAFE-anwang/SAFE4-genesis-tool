...
func NewMasterNodeStateStorage(workPath string, ownerAddr string) *MasterNodeStateStorage {
	return &MasterNodeStateStorage{workPath: workPath, ownerAddr: ownerAddr}
}

func (storage *MasterNodeStateStorage) Generate(alloc *core.GenesisAlloc) {

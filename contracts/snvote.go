...
func NewSNVoteStorage(tool *types.Tool) *SNVoteStorage {
    return &SNVoteStorage{
...
func (s *SNVoteStorage) Generate(alloc *types.GenesisAlloc) {
    utils.Compile(s.solcPath, s.contractPath, "SNVote.sol")

...
func NewSuperNodeStateStorage(tool *types.Tool) *SuperNodeStateStorage {
    return &SuperNodeStateStorage{
...
func (s *SuperNodeStateStorage) Generate(alloc *types.GenesisAlloc) {
    utils.Compile(s.solcPath, s.contractPath, "SuperNodeState.sol")

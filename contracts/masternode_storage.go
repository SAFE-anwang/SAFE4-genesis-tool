...
func NewMasterNodeStorageStorage(workPath string, ownerAddr string) *MasterNodeStorageStorage {
	return &MasterNodeStorageStorage{workPath: workPath, ownerAddr: ownerAddr}
}

func (storage *MasterNodeStorageStorage) Generate(alloc *core.GenesisAlloc) {
	...
	for i := range contractNames {
		...
		if contractNames[i] == "TransparentUpgradeableProxy" {
			...
			// no
			storage.buildNo(&account, masternodes)

			// addr2info
			storage.buildAddr2Info(&account, masternodes)

			// ids
			storage.buildIDs(&account, masternodes)

			// id2addr
			storage.buildID2Addr(&account, masternodes)

			// enode2addr
			storage.buildEnode2Addr(&account, masternodes)
		}
...
func (storage *MasterNodeStorageStorage) buildNo(account *core.GenesisAccount, masternodes *[]types.MasterNodeInfo) {
...
func (storage *MasterNodeStorageStorage) buildAddr2Info(account *core.GenesisAccount, masternodes *[]types.MasterNodeInfo) {
	var curKey *big.Int
	for _, masternode := range *masternodes {
		storage.calcId(account, masternode, &curKey)
		storage.calcAddr(account, masternode, &curKey)
		storage.calcCreator(account, masternode, &curKey)
...
func (storage *MasterNodeStorageStorage) calcId(account *core.GenesisAccount, masternode types.MasterNodeInfo, curKey **big.Int) {
...
func (storage *MasterNodeStorageStorage) calcAddr(account *core.GenesisAccount, masternode types.MasterNodeInfo, curKey **big.Int) {
	*curKey = big.NewInt(0).Add(*curKey, big.NewInt(1))
	storageKey, storageValue := utils.GetStorage4Addr(*curKey, masternode.Addr)
	account.Storage[storageKey] = storageValue
}

func (storage *MasterNodeStorageStorage) calcCreator(account *core.GenesisAccount, masternode types.MasterNodeInfo, curKey **big.Int) {
	*curKey = big.NewInt(0).Add(*curKey, big.NewInt(1))
	storageKey, storageValue := utils.GetStorage4Addr(*curKey, masternode.Creator)
	account.Storage[storageKey] = storageValue
}

func (storage *MasterNodeStorageStorage) calcEnode(account *core.GenesisAccount, masternode types.MasterNodeInfo, curKey **big.Int) {
	*curKey = big.NewInt(0).Add(*curKey, big.NewInt(1))
...
func (storage *MasterNodeStorageStorage) calcDesc(account *core.GenesisAccount, masternode types.MasterNodeInfo, curKey **big.Int) {
	*curKey = big.NewInt(0).Add(*curKey, big.NewInt(1))
...
func (storage *MasterNodeStorageStorage) calcIsOfficial(account *core.GenesisAccount, masternode types.MasterNodeInfo, curKey **big.Int) {
	*curKey = big.NewInt(0).Add(*curKey, big.NewInt(1))
...
func (storage *MasterNodeStorageStorage) calcFounders(account *core.GenesisAccount, masternode types.MasterNodeInfo, curKey **big.Int) {
	*curKey = big.NewInt(0).Add(*curKey, big.NewInt(1))
...
func (storage *MasterNodeStorageStorage) calcIncentivePlan(account *core.GenesisAccount, masternode types.MasterNodeInfo, curKey **big.Int) {
	var storageKey, storageValue common.Hash
	// creator
	*curKey = big.NewInt(0).Add(*curKey, big.NewInt(1))
...
func (storage *MasterNodeStorageStorage) buildIDs(account *core.GenesisAccount, masternodes *[]types.MasterNodeInfo) {
...
func (storage *MasterNodeStorageStorage) buildID2Addr(account *core.GenesisAccount, masternodes *[]types.MasterNodeInfo) {
	for _, masternode := range *masternodes {
...
func (storage *MasterNodeStorageStorage) buildEnode2Addr(account *core.GenesisAccount, masternodes *[]types.MasterNodeInfo) {
	for _, masternode := range *masternodes {

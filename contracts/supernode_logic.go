...
func NewSuperNodeLogicStorage(tool *types.Tool) *SuperNodeLogicStorage {
    return &SuperNodeLogicStorage{
...
func (s *SuperNodeLogicStorage) Generate(alloc *types.GenesisAlloc) {
    utils.Compile(s.solcPath, s.contractPath, "SuperNodeLogic.sol")
